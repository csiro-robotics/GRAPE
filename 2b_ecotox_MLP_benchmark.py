...
from sklearn.metrics import roc_auc_score, f1_score, precision_score, recall_score, roc_curve, accuracy_score, classification_report
...
if __name__ == '__main__':
    ...
    model = mlp_model(dim_u, dim_v, args.hdim1, args.hdim2, args.hdim3, args.outdim, args.p_gcn)
    model.to(device)
    ...
    if args.train_flag==1:
        ...
        exp_name = name_str+'eco_onlymlp_with_d'+'_ep'+str(args.epochs)+'_h1'+str(args.hdim1)+'_h2'+str(args.hdim2)+'_h3'+str(args.hdim3)+'_o'+str(args.outdim)+'_lr'+ str(args.lr)+'_pg'+ str(args.p_gcn)
        print(exp_name)
        ...
        with open(args.model_folder+'best_models.txt', 'a') as file:
